 ...
 * @brief This program evaluates prefix expressions. 
 * @version 0.1
 * @date 2020-09-28
 * 
 */
...
/**
 * @brief Takes an istream that contains a single prefix expression
 *        p and returns the integer value of p.
 * 
 * @param exprStream  expression stream
 * @return int        numeric value of the evaluated expression
 */
int prefixExpr(istream &exprStream)
{
